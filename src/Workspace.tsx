    ...
    <div className="relative min-h-[100dvh] bg-[var(--color-canvas)] text-[var(--color-ink)] font-[var(--font-sans)]">
      ...
      <main className="relative z-[1] max-w-[1400px] mx-auto px-6 pt-8 pb-20">
        ...
        <div className="reveal">
          {activeTab === 'compile' && React.createElement(LlmOsPromptCompiler as any, { user, saveToDrive })}
          {activeTab === 'chat' && React.createElement(LlmOsCoreInterface as any, { user })}
          {activeTab === 'guard' && React.createElement(DataFlywheelGuard as any, { user, saveToDrive })}
          {activeTab === 'academy' && React.createElement(DataFlywheelAcademy as any, { user, saveToDrive })}
          {activeTab === 'repoCenter' && React.createElement(VibeRepoCenter as any, { user, saveToDrive })}
          {activeTab === 'onboarding' && React.createElement(VibeOnboardingScaffold as any, { user, saveToDrive })}
          {activeTab === 'repoArchitect' && React.createElement(VibeRepoArchitect as any, { user, saveToDrive })}
          {activeTab === 'riskDashboard' && React.createElement(RiskMitigationDashboard as any, { user, saveToDrive })}
          {activeTab === 'sovereignInsight' && React.createElement(SovereignInsight as any, { user, saveToDrive })}
          {activeTab === 'gravitasBoard' && React.createElement(GravitasBoard as any, { user, saveToDrive })}
          {activeTab === 'refinementLoop' && React.createElement(RefinementLoop as any, { user, saveToDrive })}
          {activeTab === 'memoryManager' && React.createElement(MemoryManager as any, { user, saveToDrive })}
          {activeTab === 'impulsivityShield' && React.createElement(ImpulsivityShield as any, { user, saveToDrive })}
          {activeTab === 'skeletonViewer' && React.createElement(SkeletonViewer as any, { user, saveToDrive })}
          {activeTab === 'vectorAdvisor' && React.createElement(VectorAdvisor as any, { user, saveToDrive })}
        </div>
        ...
        <footer className="mt-16 pt-9 pb-7 border-t border-[var(--color-hairline)]">
          <div className="flex justify-between items-center gap-4 flex-wrap font-[var(--font-mono)] text-[11px] text-[var(--color-muted)] tracking-[0.06em]">
            <span>SloppyXBaby &middot; Evidence-Based Design &middot; 2025</span>
